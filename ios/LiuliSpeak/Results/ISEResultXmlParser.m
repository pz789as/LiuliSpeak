...
ISEResultPhone* createPhone(NSDictionary* attrDic) {
    ...
    phone.single_syll = [attrDic objectForKey:@"is_single_syll_word"];
    phone.yun = [attrDic objectForKey:@"is_yun"];
    phone.label_gop = [attrDic objectForKey:@"label_gop"];
    phone.likelihood = [attrDic objectForKey:@"likelihood"];
    phone.label_rec_name = [attrDic objectForKey:@"label_rec_name"];
    phone.label_rec_tone = [attrDic objectForKey:@"label_rec_tone"];
    phone.mono_tone = [attrDic objectForKey:@"mono_tone"];
    phone.pair_score = [attrDic objectForKey:@"pair_score"];
    phone.tgpp = [attrDic objectForKey:@"tgpp"];
    phone.tone = [attrDic objectForKey:@"tone"];
    phone.tone_ratio = [attrDic objectForKey:@"tone_ratio"];
    phone.wpp = [attrDic objectForKey:@"wpp"];
