...
export default class Sentence extends Component {
    ...
    shouldComponentUpdate(nProps,nStates) {
        if(nProps.words != this.props.words){
            ...
            this.setSyllableColor(this.props.arrScore);
            logf("NewSentence Should Update:",this.props.arrScore);
            return true;
        }else if(nProps.arrScore != this.props.arrScore){
            this.setSyllableColor(nProps.arrScore);
            logf("NewSentence Should Update:",nProps.arrScore);
            return true;
        }
        return false;
    }    
